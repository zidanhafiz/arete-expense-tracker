...
describe('User Schemas', () => {
  describe('registerUserSchema', () => {
    ...
    it('should reject when first_name is too short', () => {
      ...
      // Assert
      expect(() => registerUserSchema.parse(invalidData)).toThrow(/first name must be at least 3 characters/i);
    });
    ...
    it('should reject when last_name is too short', () => {
      ...
      // Assert
      expect(() => registerUserSchema.parse(invalidData)).toThrow(/last name must be at least 3 characters/i);
    });
    ...
    it('should reject when nickname is too short', () => {
      ...
      // Assert
      expect(() => registerUserSchema.parse(invalidData)).toThrow(/nickname must be at least 3 characters/i);
    });
    ...
    it('should reject with invalid email', () => {
      ...
      // Assert
      expect(() => registerUserSchema.parse(invalidData)).toThrow(/invalid email/i);
    });
    ...
    it('should reject when password is too short', () => {
      ...
      // Assert
      expect(() => registerUserSchema.parse(invalidData)).toThrow(/password must be at least 8 characters/i);
    });
    ...
    it('should reject when passwords do not match', () => {
      ...
      // Assert
      expect(() => registerUserSchema.parse(invalidData)).toThrow(/passwords do not match/i);
    });
  ...
  describe('loginUserSchema', () => {
    ...
    it('should reject with invalid email', () => {
      ...
      // Assert
      expect(() => loginUserSchema.parse(invalidData)).toThrow(/invalid email/i);
    });
    ...
    it('should reject when password is too short', () => {
      ...
      // Assert
      expect(() => loginUserSchema.parse(invalidData)).toThrow(/password must be at least 8 characters/i);
    });
