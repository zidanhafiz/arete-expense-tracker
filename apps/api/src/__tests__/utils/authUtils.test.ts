...
describe("Auth Utils", () => {
  ...
  describe("generateAccessToken", () => {
    ...
    it("should throw error if SECRET_ACCESS_KEY is not defined", () => {
      ...
      // Execute and Assert
      expect(() => generateAccessToken(mockUserId)).toThrow(
        "SECRET_ACCESS_KEY is not defined"
      );
    });
  });
  ...
  describe("generateRefreshToken", () => {
    ...
    it("should throw error if SECRET_REFRESH_KEY is not defined", () => {
      ...
      // Execute and Assert
      expect(() => generateRefreshToken(mockUserId)).toThrow(
        "SECRET_REFRESH_KEY is not defined"
      );
    });
  });
